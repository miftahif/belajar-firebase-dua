...
class MinumanDetail extends StatelessWidget {
  final String minumanassetPath;
  final String minumancookieprice;
  final String minumancookiename;

  const MinumanDetail({
    Key? key,
    required this.minumanassetPath,
    required this.minumancookieprice,
    required this.minumancookiename,
  }) : super(key: key);
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage(minumanassetPath),
                  ),
                ),
              ),
            ),
                ...
                child: InkWell(
                  onTap: () async {
                    await FlutterLaunch.launchWhatsapp(
                      ...
                      //phone: '6285640899224',
                      message:
                          "Hi Warung Ibu Ani, Saya mau order $minumancookiename untuk hari ini, apa bisa diantar kerumah?",
                    );
                  },
                  child: Row(
