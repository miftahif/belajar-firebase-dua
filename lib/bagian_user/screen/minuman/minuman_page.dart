import 'package:belajar_firebase_dua/bagian_user/data/minuman.dart';
import 'package:belajar_firebase_dua/bagian_user/screen/minuman/minuman_detail.dart';
...
// import 'package:flutter_cakery_shop_ui/screen/minuman/minuman_detail.dart';
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return _buildCard(listMinuman[index], context);
          },
      ...
      child: InkWell(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) {
            return MinumanDetail(
              minumanassetPath: minuman.imageUrl,
              minumancookieprice: minuman.price,
              minumancookiename: minuman.name,
            );
          }));
        },
        child: Container(
...
class DatabaseMinuman extends StatelessWidget {
  const DatabaseMinuman({Key? key}) : super(key: key);
