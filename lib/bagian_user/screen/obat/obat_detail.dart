...
class ObatDetail extends StatelessWidget {
  final String obatassetPath;
  final String obatcookieprice;
  final String obatcookiename;

  const ObatDetail({
    Key? key,
    required this.obatassetPath,
    required this.obatcookieprice,
    required this.obatcookiename,
  }) : super(key: key);
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage(obatassetPath),
                  ),
                ),
              ),
            ),
                ...
                child: InkWell(
                  onTap: () async {
                    await FlutterLaunch.launchWhatsapp(
                      ...
                      //phone: '6285640899224',
                      message:
                          "Hi Warung Ibu Ani,Saya mau order $obatcookiename untuk hari ini, apa bisa diantar kerumah?",
                    );
                  },
                  child: Row(
