import 'package:belajar_firebase_dua/bagian_user/data/rokok.dart';
import 'package:belajar_firebase_dua/bagian_user/screen/rokok/rokok_detail.dart';
...
// import 'package:flutter_cakery_shop_ui/data/rokok.dart';
...
// import 'package:flutter_cakery_shop_ui/screen/rokok/rokok_detail.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

//import '../data/cake.dart';

class RokokPage extends StatelessWidget {
  const RokokPage({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return _buildCard(listRokok[index], context);
          },
          itemCount: listRokok.length,
        ),
      ),
    );
  }
      ...
      child: InkWell(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) {
            return RokokDetail(
              rokokassetPath: rokok.imageUrl,
              rokokcookieprice: rokok.price,
              rokokcookiename: rokok.name,
            );
          }));
        },
        child: Container(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage(rokok.imageUrl),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
...
class DatabaseRokok extends StatelessWidget {
  const DatabaseRokok({Key? key}) : super(key: key);
