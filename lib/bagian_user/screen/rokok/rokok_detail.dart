...
class RokokDetail extends StatelessWidget {
  final String rokokassetPath;
  final String rokokcookieprice;
  final String rokokcookiename;

  const RokokDetail({
    Key? key,
    required this.rokokassetPath,
    required this.rokokcookieprice,
    required this.rokokcookiename,
  }) : super(key: key);
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: AssetImage(rokokassetPath),
                  ),
                ),
              ),
            ),
                ...
                child: InkWell(
                  onTap: () async {
                    await FlutterLaunch.launchWhatsapp(
                      ...
                      //phone: '6285640899224',
                      message:
                          "Hi Warung Ibu Ani,Saya mau order $rokokcookiename untuk hari ini, apa bisa diantar kerumah?",
                    );
                  },
                  child: Row(
